...
export function DitchIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M0 30 Q16 44 32 38 Q48 32 64 42 L64 54 Q48 44 32 50 Q16 56 0 42 Z" fill="#42a5f5" />
			<path d="M0 34 Q16 48 32 42 Q48 36 64 46 L64 58 Q48 48 32 54 Q16 60 0 46 Z" fill="#1e88e5" />
			<path d="M4 24 L8 16 L6 24" stroke="#4caf50" stroke-width="1.5" fill="none" />
			<path d="M56 22 L60 12 L58 22" stroke="#4caf50" stroke-width="1.5" fill="none" />
		</svg>
	);
}
...
export function GlassIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path d="M20 12 L22 40 L42 40 L44 12 Z" fill="#e3f2fd" stroke="#90caf9" stroke-width="1.5" />
...
export function WormIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M20 44 Q20 28 28 28 Q36 28 36 38 Q36 44 42 44" stroke="#e91e63" stroke-width="5" stroke-linecap="round" fill="none" />
...
export function SnakeIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path d="M12 48 Q12 20 24 20 Q36 20 36 36 Q36 48 48 48 Q56 48 56 40 L56 36" stroke="#4caf50" stroke-width="5" stroke-linecap="round" fill="none" />
...
export function MoustacheIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path d="M8 32 Q14 24 22 30 Q28 34 32 30 Q36 34 42 30 Q50 24 56 32 Q50 40 42 36 Q36 32 32 36 Q28 32 22 36 Q14 40 8 32 Z" fill="#5d4037" />
		</svg>
	);
}
...
export function SnotIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M30 38 Q32 44 34 38" stroke="#81c784" stroke-width="2.5" stroke-linecap="round" fill="#a5d6a7" />
			<path d="M28 16 Q26 10 30 12" stroke="#ffcc80" stroke-width="2" fill="none" />
			<path d="M36 16 Q38 10 34 12" stroke="#ffcc80" stroke-width="2" fill="none" />
		</svg>
	);
}
...
export function NlFlag(props: IconProps) {
	return (
		<svg viewBox="0 0 36 24" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<rect x="1" y="1" width="34" height="22" rx="2" stroke="#bbb" stroke-width="0.8" fill="none" />
		</svg>
	);
}
...
export function DeityIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<circle cx="32" cy="10" r="14" fill="none" stroke="#fdd835" stroke-width="2" />
			<circle cx="28" cy="18" r="1.5" fill="#333" />
			<circle cx="36" cy="18" r="1.5" fill="#333" />
			<path d="M28 24 Q32 28 36 24" stroke="#333" stroke-width="1.2" fill="none" />
		</svg>
	);
}
...
export function ThumbsUpIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path d="M28 44 L28 24 Q28 16 34 14 L36 14 L36 24 L46 24 Q50 24 50 28 L48 44 Q48 48 44 48 L32 48 Q28 48 28 44 Z" fill="#ffcc80" stroke="#e6b06e" stroke-width="1.5" />
...
export function SkirtIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M24 16 L32 52" stroke="#ad1457" stroke-width="0.8" opacity="0.3" />
			<path d="M40 16 L32 52" stroke="#ad1457" stroke-width="0.8" opacity="0.3" />
		</svg>
	);
}
...
export function CoatIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path d="M20 16 L28 12 L36 12 L44 16 L46 48 L36 48 L36 52 L28 52 L28 48 L18 48 Z" fill="#5d4037" />
...
export function ToughIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M28 26 L36 26" stroke="#333" stroke-width="1.5" stroke-linecap="round" />
		</svg>
	);
}
...
export function BigIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M30 50 L14 58" stroke="#666" stroke-width="1" stroke-dasharray="2" />
		</svg>
	);
}
...
export function KissIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<title>Kus</title>
			<path d="M20 28 Q20 16 32 16 Q44 16 44 28 Q44 40 32 48 Q20 40 20 28 Z" fill="#e91e63" />
			<path d="M32 16 Q32 28 44 28" stroke="#c2185b" stroke-width="1" fill="none" />
...
export function PeaceIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<title>Vrede</title>
			<circle cx="32" cy="32" r="20" fill="none" stroke="#7cb342" stroke-width="3" />
...
export function AngerIcon(props: IconProps) {
	return (
		<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M22 24 L28 28" stroke="#c62828" stroke-width="2.5" stroke-linecap="round" />
			<path d="M42 24 L36 28" stroke="#c62828" stroke-width="2.5" stroke-linecap="round" />
			<circle cx="27" cy="30" r="2" fill="#333" />
			<circle cx="37" cy="30" r="2" fill="#333" />
			<path d="M24 38 Q32 34 40 38" stroke="#333" stroke-width="2" fill="none" />
